package hommie.hommie.configuration;

import hommie.hommie.authentication.MyUserService;
import hommie.hommie.jwt.JwtConfig;
import hommie.hommie.jwt.TokenVerifier;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
   ...
   MyUserService myUserService;
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000/","https://v3-ashen.vercel.app/")); //or add * to allow all origins
